...
public class ModifyBoatMesh 
{
	...
	public void GenerateUnderwaterMesh(ref List<Vector3> intersectionVertices)
	{
		//Reset
		...
		//Add the triangles
		AddTriangles(ref intersectionVertices);
	}
	
	
	
	//Add all the triangles that's part of the underwater and abovewater meshes
	private void AddTriangles(ref List<Vector3> intersectionVertices)
	{
		...
		while (i < boatTriangles.Length)
		{
			...
			else
			{
				...
				if (vertexData[0].distance > 0f && vertexData[1].distance < 0f && vertexData[2].distance < 0f)
				{
					AddTrianglesOneAboveWater(vertexData, triangleCounter, ref intersectionVertices);
				}
				...
				{
					AddTrianglesTwoAboveWater(vertexData, triangleCounter, ref intersectionVertices);
				}
			}
	...
	private void AddTrianglesOneAboveWater(List<VertexData> vertexData, int triangleCounter, ref List<Vector3> intersectionVertices)
	{
	...
	private void AddTrianglesTwoAboveWater(List<VertexData> vertexData, int triangleCounter, ref List<Vector3> intersectionVertices)
	{
